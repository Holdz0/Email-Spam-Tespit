'''
	GMAİL verilerini Python kullanarak okuma
	- Taha Efe Tuncer		Kodun iskeletinin sahibi = Abhishek Chhibber						
'''

'''
Bu komut dosyası aşağıdaki işlemleri gerçekleştirir:

-Gmail gelen kutusuna gidin
-Okunmamış tüm iletileri bulun ve okuyun
-Detayları (Tarih, Gönderen, Konu, Özet, İçerik) çıkarın ve bunları bir .csv dosyasına / veritabanına aktarın
-İletileri Okundu olarak işaretler ve tekrar okunmaz
'''
...
if not creds or creds.invalid:
    flow = client.flow_from_clientsecrets('client_secret_489430401115-qlvii1svq0ttpd24fbnmej98ppm3srpk.apps.googleusercontent.com.json', SCOPES)
